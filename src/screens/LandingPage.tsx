...
const QUOTES = [
  ...
  { text: 'Every page is a small door, and reading is the courage to open it.', author: 'DEAR Hub' },
  { text: 'A quiet reading hour can make a loud difference in the way you see the world.', author: 'DEAR Hub' },
  { text: 'Reading turns borrowed words into personal understanding.', author: 'DEAR Hub' },
  { text: 'The best reading habit begins with one page you genuinely want to turn.', author: 'DEAR Hub' },
  { text: 'A book gives your imagination somewhere meaningful to go.', author: 'DEAR Hub' },
  { text: 'Read slowly enough for an idea to become your own.', author: 'DEAR Hub' },
  { text: 'A curious reader is always carrying a question worth answering.', author: 'DEAR Hub' },
  { text: 'Reading is a conversation where the pages wait patiently for your thoughts.', author: 'DEAR Hub' },
  { text: 'One thoughtful paragraph can change the direction of an entire day.', author: 'DEAR Hub' },
  { text: 'Books do not just fill time; they give time more meaning.', author: 'DEAR Hub' },
  { text: 'The page becomes memorable when you pause long enough to meet it.', author: 'DEAR Hub' },
  { text: 'Reading is practice for noticing what other people might miss.', author: 'DEAR Hub' },
  { text: 'A summary is not smaller thinking; it is thinking made clear.', author: 'DEAR Hub' },
  { text: 'The strongest readers bring their own questions to every chapter.', author: 'DEAR Hub' },
  { text: 'A book can lend you a new perspective without asking you to leave your seat.', author: 'DEAR Hub' },
  { text: 'Read for information, stay for the unexpected idea.', author: 'DEAR Hub' },
  { text: 'The more stories you enter, the more lives you learn to understand.', author: 'DEAR Hub' },
  { text: 'A reading habit is a daily invitation to become a little more curious.', author: 'DEAR Hub' },
  { text: 'Good reading leaves a question behind after the page ends.', author: 'DEAR Hub' },
  { text: 'DEAR time is a pause where attention gets to be the main activity.', author: 'DEAR Hub' },
  { text: 'Drop everything, open a page, and give your mind room to stretch.', author: 'DEAR Hub' },
  { text: 'A DEAR moment turns stillness into discovery.', author: 'DEAR Hub' },
  { text: 'Reading together begins with everyone finding their own quiet focus.', author: 'DEAR Hub' },
  { text: 'A classroom full of readers is a room full of growing possibilities.', author: 'DEAR Hub' },
  { text: 'DEAR is not about rushing through pages; it is about showing up for them.', author: 'DEAR Hub' },
  { text: 'When the room gets quiet, a thousand ideas can begin moving.', author: 'DEAR Hub' },
  { text: 'A reading routine makes space for imagination to become a habit.', author: 'DEAR Hub' },
  { text: 'The page you choose today may become the thought you need tomorrow.', author: 'DEAR Hub' },
  { text: 'Reading is a way to practice paying attention with purpose.', author: 'DEAR Hub' },
  { text: 'A reader does not need perfect focus; they only need to return to the page.', author: 'DEAR Hub' },
  { text: 'Every book has a rhythm, and every reader finds a different beat.', author: 'DEAR Hub' },
  { text: 'The right sentence can feel like a window opening inside your mind.', author: 'DEAR Hub' },
  { text: 'Reading gives your questions better words.', author: 'DEAR Hub' },
  { text: 'A page is a place where patience becomes insight.', author: 'DEAR Hub' },
  { text: 'The habit of reading is built from ordinary minutes used remarkably well.', author: 'DEAR Hub' },
  { text: 'A good book does not tell you what to think; it gives you more to think about.', author: 'DEAR Hub' },
  { text: 'Read to collect ideas, then reflect to connect them.', author: 'DEAR Hub' },
  { text: 'A reader grows every time they notice something new in familiar words.', author: 'DEAR Hub' },
  { text: 'Stories help us travel farther than our schedules allow.', author: 'DEAR Hub' },
  { text: 'Reading is a quiet skill with a remarkably wide horizon.', author: 'DEAR Hub' },
  { text: 'The page rewards the reader who is willing to wonder.', author: 'DEAR Hub' },
  { text: 'A book can be both a mirror for your experience and a map beyond it.', author: 'DEAR Hub' },
  { text: 'Reflection is where reading becomes learning.', author: 'DEAR Hub' },
  { text: 'The most useful thing you can bring to a book is an open mind.', author: 'DEAR Hub' },
  { text: 'Reading well means listening closely to ideas that are not your own.', author: 'DEAR Hub' },
  { text: 'A chapter is a starting point for thought, not the finish line.', author: 'DEAR Hub' },
  { text: 'A reader with a notebook turns moments into memory.', author: 'DEAR Hub' },
  { text: 'The calm of reading can make room for the clarity of writing.', author: 'DEAR Hub' },
  { text: 'A thoughtful summary is proof that an idea found somewhere to land.', author: 'DEAR Hub' },
  { text: 'Every reading session is a chance to practice becoming more attentive.', author: 'DEAR Hub' },
  { text: 'Books make distance feel temporary and curiosity feel close.', author: 'DEAR Hub' },
  { text: 'Read a little, think deeply, and let the meaning take its time.', author: 'DEAR Hub' },
  { text: 'A page can be small enough to hold and big enough to change you.', author: 'DEAR Hub' },
  { text: 'Readers learn to see both the words and the world behind them.', author: 'DEAR Hub' },
  { text: 'A reading goal matters, but the discovery along the way matters too.', author: 'DEAR Hub' },
  { text: 'The best books make your inner world feel larger.', author: 'DEAR Hub' },
  { text: 'Reading is an exercise in empathy, patience, and imagination.', author: 'DEAR Hub' },
  { text: 'A story remembered is a story that keeps doing work inside you.', author: 'DEAR Hub' },
  { text: 'DEAR Hub begins with a page and grows through attention.', author: 'DEAR Hub' },
  { text: 'The goal of reading is not only to finish, but to understand.', author: 'DEAR Hub' },
  { text: 'A reader can turn a few quiet minutes into a lasting insight.', author: 'DEAR Hub' },
  { text: 'Books teach us that another point of view is an opportunity, not a threat.', author: 'DEAR Hub' },
  { text: 'The page is patient with you; give yourself the same patience.', author: 'DEAR Hub' },
  { text: 'Reading is how a question learns to become a better question.', author: 'DEAR Hub' },
  { text: 'A focused reader notices details that a hurried reader leaves behind.', author: 'DEAR Hub' },
  { text: 'A DEAR assignment is a chance to read, think, and leave evidence of both.', author: 'DEAR Hub' },
  { text: 'The words may be printed, but the understanding is built by you.', author: 'DEAR Hub' },
  { text: 'A new book is a new lens for looking at familiar life.', author: 'DEAR Hub' },
  { text: 'Reading gives imagination both fuel and direction.', author: 'DEAR Hub' },
  { text: 'The reader who pauses often may understand more than the reader who races ahead.', author: 'DEAR Hub' },
  { text: 'A page becomes powerful when you connect it to something you already know.', author: 'DEAR Hub' },
  { text: 'Reading is a daily way to make your world more detailed.', author: 'DEAR Hub' },
  { text: 'A good reflection does not repeat the page; it responds to it.', author: 'DEAR Hub' },
  { text: 'Books help us practice being present in places we have never been.', author: 'DEAR Hub' },
  { text: 'A reader is someone who keeps making room for new ideas.', author: 'DEAR Hub' },
  { text: 'Read the sentence twice if it gives you something worth keeping.', author: 'DEAR Hub' },
  { text: 'The best reading spaces are built from attention, not silence alone.', author: 'DEAR Hub' },
  { text: 'Every story carries a point of view; every reader brings another.', author: 'DEAR Hub' },
  { text: 'Reading is a quiet form of exploration with no map required.', author: 'DEAR Hub' },
  { text: 'A thoughtful reader turns information into understanding and understanding into action.', author: 'DEAR Hub' },
  { text: 'One page can start a chain of questions that lasts all day.', author: 'DEAR Hub' },
  { text: 'A book is a conversation across time, distance, and experience.', author: 'DEAR Hub' },
  { text: 'DEAR time reminds us that attention is something worth protecting.', author: 'DEAR Hub' },
  { text: 'The more carefully you read, the more generously you can think.', author: 'DEAR Hub' },
  { text: 'A summary is a bridge between what you read and what you understood.', author: 'DEAR Hub' },
  { text: 'Reading does not make the world smaller; it makes your understanding wider.', author: 'DEAR Hub' },
  { text: 'A reader can find a new beginning in the middle of a familiar story.', author: 'DEAR Hub' },
  { text: 'Books remind us that learning can feel like wonder.', author: 'DEAR Hub' },
  { text: 'A quiet page can help a busy mind find its center.', author: 'DEAR Hub' },
  { text: 'Read with curiosity, write with honesty, and reflect with care.', author: 'DEAR Hub' },
  { text: 'The value of a reading session is measured in insight, not speed.', author: 'DEAR Hub' },
  { text: 'A story can give you language for a feeling you could not name before.', author: 'DEAR Hub' },
  { text: 'Reading is a habit that keeps your imagination in good shape.', author: 'DEAR Hub' },
  { text: 'The page is where curiosity gets practical.', author: 'DEAR Hub' },
  { text: 'A reader grows by noticing, questioning, connecting, and returning.', author: 'DEAR Hub' },
  { text: 'DEAR Hub makes space for the kind of learning that begins quietly.', author: 'DEAR Hub' },
  { text: 'A book can change your answer by improving your question.', author: 'DEAR Hub' },
  { text: 'Reading is proof that stillness can be an active adventure.', author: 'DEAR Hub' },
  { text: 'Every thoughtful paragraph is a small act of discovery.', author: 'DEAR Hub' },
  { text: 'The reader who reflects carries more than the reader who only remembers.', author: 'DEAR Hub' },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="px-4 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="partner-slider overflow-hidden" aria-label="DEAR Hub technology partners">
            <div className="partner-slider-track">
              {[0, 1].map((group) => (
                <div className="partner-slider-group" key={group} aria-hidden={group === 1}>
                  {PARTNERS.map((partner) => (
                    <button
                      key={`${group}-${partner.name}`}
                      onClick={() => handlePartnerClick(partner)}
                      className="partner-card glass rounded-2xl p-5 text-center group flex flex-col items-center"
                      tabIndex={group === 1 ? -1 : undefined}
                    >
                      <img src={partner.logo} alt={group === 1 ? '' : partner.name} className="partner-logo h-12 w-12 object-contain mb-2" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                      <p className="partner-title text-sm font-semibold text-app-primary group-hover:text-[var(--primary-color)] transition">{partner.name}</p>
                      <p className="partner-description text-xs text-app-muted mt-1">{partner.desc}</p>
                    </button>
                  ))}
                </div>
              ))}
